...
def get_fg_mask(frame):
    ...
    _, white_region = cv2.threshold(gray, 110, 255, cv2.THRESH_BINARY)
...
UPPER_BROWN = np.array([80, 80, 80]) # works for all flies except the one in the rightside

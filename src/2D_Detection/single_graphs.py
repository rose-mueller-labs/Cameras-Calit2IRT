...
# params
vid_names = ['CO1d14.mov', 'CO1d42.mov', 'CO2d14.mov', 'CO2d42.mov', 'CO3d14.mov', 'CO3d42.mov', 'CO4d14.mov', 'CO4d42.mov', 'CO5d14.mov', 'CO5d42.mov',
             'ACO1.mov', 'ACO2.mov', 'ACO3.mov', 'ACO4.mov', 'ACO5.mov']

for vid_name in vid_names:
    csv_path = f"./WatershedAlgorithm/Output/Velocity/CalitVids{vid_name[:2]}/Tracked_{vid_name}_pwsBacklitV3_debug.csv"
    ...
    start_frame = df["frame"].iloc[25*fps]

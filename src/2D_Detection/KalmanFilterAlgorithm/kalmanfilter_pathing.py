...
for vid_path in [
    ...
    output_path = f'./2D_Detection/KalmanFilterAlgorithm/Output/{name}_written_kf_path.mp4'
    csv_path = f'./2D_Detection/KalmanFilterAlgorithm/Output/tracked_{name}_kfPathing.csv'
    ...
    frame_data = {} # dict[int, dict[int, tuple]]
    all_obj_ids = set()
    ...
    total_frames = frame_idx  # 0 .. frame_idx-1
